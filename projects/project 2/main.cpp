...
==3737==
==3737== HEAP SUMMARY:
==3737==     in use at exit: 0 bytes in 0 blocks
==3737==   total heap usage: 101 allocs, 101 frees, 3,890 bytes allocated
==3737==
==3737== All heap blocks were freed -- no leaks are possible
==3737==
==3737== For counts of detected and suppressed errors, rerun with: -v
==3737== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 1 from 1)
